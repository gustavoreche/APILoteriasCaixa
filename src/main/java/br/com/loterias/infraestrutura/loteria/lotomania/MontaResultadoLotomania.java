package br.com.loterias.infraestrutura.loteria.lotomania;
...
@Component("lotomania")
@RequestScope
public class MontaResultadoLotomania implements MontaResultado<Loteria> {
	...
	public boolean executa(String linhaParaSerAnalisada) {
		return preenchedorDeCampo.continuaPreenchendo(linhaParaSerAnalisada, EnumTipoDeLoteria.LOTOMANIA, this, contadorParaPegarNumeroDoConcurso);
	}
	
	@Override
	public Loteria objetoMontado() {
		return new Loteria(EnumTipoDeLoteria.LOTOMANIA, this.numeros, this.numeroDeGanhadores, this.numeroDoConcurso, this.dataDoUltimoSorteio);
	}
