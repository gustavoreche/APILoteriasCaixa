...
@Component("generico")
@RequestScope
public class PegarNumerosSorteadosGenerico implements PegarNumerosSorteados<List<Integer>> {
	
	private static final String SAO_OS_NUMEROS_SORTEADOS = "resultado-loteria ";
